...
var HistoryContainer = import_styled_components4.default.div`
...
`;
var HistoryList = import_styled_components4.default.div`
    flex: 1;
    overflow: auto;
    max-height: 21.2rem;
...
var Status = import_styled_components4.default.span`
    display: flex;
    align-items: center;
    gap: .5rem;
...
var NotFoundContainer = import_styled_components5.default.div`
...
var LayoutContainer = import_styled_components6.default.div`
    max-width: 74rem;
